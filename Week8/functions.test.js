...
test('returns e when E is passed to the function', () => {
  expect(functions.insertConstantInField('E')).toBe("e");
})

test('returns the pi symbol when PI is passed to the function', () => {
  expect(functions.insertConstantInField('PI')).toBe("&#120529");
})
